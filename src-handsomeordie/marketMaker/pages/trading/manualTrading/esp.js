    ...
    render() {
        ...
        return (
            <div style={{padding:"10px 30px",display:"flex", height: this.props.contentHeight,overflow:"auto"}}>
                ...
                <div style={{flex:11,alignItems: odmVertical,justifyContent: "center",display: "flex"}}>
                            ...
                            {getFieldDecorator("quantity", {
                                ...
                                <div>
                                    ...
                                    <Button size="small" onClick={()=>{
                                        this.setState({side: "BUY", selectedSide: true, amount: undefined, price: undefined});
                                    }} style={{background: this.state.side === "BUY" ? "#ffCC99" : "#00CC99",flex:2,width:"30%",marginLeft:"3%"}}>BUY</Button>
                                    <Button size="small" onClick={()=>{
                                        this.setState({side: "SELL", selectedSide: true, amount: undefined, price: undefined});
...
const ESPForm = Form.create()(ESP);
export default connect(mapStateToProps,mapDispatchToProps)(ESPForm);