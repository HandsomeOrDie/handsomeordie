...
class RiskMng extends Component {
    ...
    render() {
        ...
        if (showMarket){
            if (showOperation){
                marketStyle = { marginTop: 10, flex: 1};
                operationStyle = { marginTop: 10, flex: 1};
            } else {
                marketStyle = { marginTop: 10, flex: 1};
                operationStyle = { marginTop: 10};
            }
        } else {
            if (showOperation){
                marketStyle = { marginTop: 10};
                operationStyle = { marginTop: 10, flex: 1};
            } else {
                marketStyle = { marginTop: 10};
                operationStyle = { marginTop: 10};
        ...
        return (
            <div style={{width: document.documentElement.clientWidth - 270, display: "flex", flex: "1", flexDirection: "column", height: cardHeight-40,margin:"0 10px"}}>
                ...
                <Card bodyStyle={{height:"100%",padding:"0 10px"}} style={operationStyle}>
