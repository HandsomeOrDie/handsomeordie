...
import { getMarketRiskList, deleteMarketRisk, addMarketRisk, saveMarketRisk, setUnsaved, getSelectValue, setMarketRisk, setSelectValue } from "../../../actions/marketRisk";
    ...
    render() {
        ...
        return (
            <Table
                ...
                title={()=>(
                    <div>
                        ...
                        <span style={{float: "right"}}>
                            ...
                            <a onClick={this.deleteMarketRisk} style={{marginRight: 30}}><Icon type="minus-circle" style={{fontSize: 20}}/></a>
                ...
                bordered={true}
                scroll={{x: 2100, y: this.props.tableHeight}}
                columns={columns}
